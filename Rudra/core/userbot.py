...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("Prabas_JAAT_BIO")
                
                await self.one.join_chat("Prabas_JAAT_BIO")
            except:
                pass
            assistants.append(3)
            try:
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("Prabas_JAAT_BIO")
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("Prabas_JAAT_BIO")
