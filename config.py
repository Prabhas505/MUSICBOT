...
OWNER_USERNAME = getenv("OWNER_USERNAME","Prabas_JAAT_1")
...
UPSTREAM_REPO = getenv(
   "UPSTREAM_REPO",
   "https://github.com/Prabas-JAAT/Prabas-Music",
)
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "Prabas")
GIT_TOKEN = getenv(
   "GIT_TOKEN", None
)  # Fill this variable if your upstream repository is private

SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Prabas_JAAT_BIO")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/Prabas_JAAT_BIO")
